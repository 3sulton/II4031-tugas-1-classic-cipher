...
from be_playfair import playfair
...
class Playfair():
    def __init__(self, screen):
        ...
        button_playfair_on = Button(
            image=button_image_playfair_on,
            borderwidth=0,
            highlightthickness=0,
        ...
        def encrypt():
            ...
            if key == '\n':
                ...
                return
            pf = playfair(M=plain_teks, K=key)
            pf.encrypt()
            entry_output.delete("1.0", tk.END)
            if is_five_letter_formatted.get():
                pf.five_letter_format()
            entry_output.insert("1.0", pf.C)
        ...
        def decrypt():
            ...
            if key == '\n':
                tk.messagebox.showwarning(message="Keynya jangan kosong, hadeh")
                return
            pf = playfair(C=cipher_teks, K=key)
            pf.decrypt()
            entry_output.delete("1.0", tk.END)
            entry_output.insert("1.0", pf.M)
        ...
        def save_file():
            ...
            filename = "playfair-" + datetime.datetime.now().strftime("%H%M%S-%Y%m%d") + ".txt"
        ...
        canvas.create_text(
            ...
            540.0,
            anchor="nw",
            text="format file name : playfair-hms-ymd.txt",
            fill="#000000",
            font=("Poppins Regular", 15 * -1)
        )
